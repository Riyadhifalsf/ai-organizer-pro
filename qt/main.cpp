...
int main(int argc, char* argv[]) {
  ...
  app.setStyleSheet(R"(
    * { font-family: "Segoe UI"; font-size: 13px; }
    ...
    QLineEdit { background: #18213a; color: #e5ebfb; border: 1px solid #2c3a5d; border-radius: 6px; padding: 8px; }
    QLineEdit:focus { border: 1px solid #8274df; }
    QPushButton { background: #202a43; color: #dbe2f3; border: 1px solid #2c3a5d; border-radius: 6px; padding: 8px 12px; }
    ...
    QPushButton#primaryAction { background: #7567d6; color: white; border-color: #9488ed; font-weight: 600; }
    QTreeWidget, QListWidget, QTableWidget, QTextEdit, QPlainTextEdit { background: #11192d; color: #dce4f7; border: 1px solid #2c3a5d; border-radius: 6px; }
    ...
    QTabBar::tab { background: #151d33; color: #b9c4dc; padding: 10px 18px; border: 1px solid #2c3a5d; border-bottom: 0; min-width: 100px; }
    QTabBar::tab:selected { background: #28234c; color: #eeeaff; border-top: 2px solid #8274df; }
    QGroupBox { color: #e9ecf8; font-weight: 600; border: 1px solid #2c3a5d; border-radius: 7px; margin-top: 11px; padding: 15px 10px 10px; background: #121a2e; }
    QGroupBox::title { subcontrol-origin: margin; left: 10px; padding: 0 5px; color: #dbe3f9; }
    QToolBar { background: #11192d; border: 1px solid #2c3a5d; spacing: 4px; }
    QStatusBar { background: #11182c; color: #9faac4; border-top: 1px solid #2c3a5d; }
