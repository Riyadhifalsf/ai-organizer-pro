...
MODE_DESCR = {
    ...
    "yolo-classify": "klasifikasi isi gambar (YOLO, opsional): prediksi + plan CSV, dry-run default",
}
...
def parse_args(argv):
    ...
    ap.add_argument("--yolo-model", default="", metavar="PT",
                     help="(yolo-classify) path best.pt kustom (default: app/ai/yolo/best.pt).")
